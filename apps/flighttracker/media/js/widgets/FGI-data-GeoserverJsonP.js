...
Ext.define('FGI.data.proxy.GeoserverJsonP', {
    ...
    doRequest: function(operation, callback, scope) {
        ...
        request.jsonp = FGI.data.GeoserverJsonP.request(request);
 ...
 */
Ext.define('FGI.data.GeoserverJsonP', {
    ...
    request: function(options){
        ...
        params[callbackKey] = 'callback:' + name + '.data.GeoserverJsonP.' + callbackName;
        if (disableCaching) {
